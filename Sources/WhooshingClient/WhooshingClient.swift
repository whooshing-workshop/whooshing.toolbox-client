...
public typealias ProgressAction = @Sendable (_ progress: ProgressContext<HTTPResponse?>) throws -> Void
...
public protocol WhooshingClient: AnyObject,Sendable {
    ...
    func patch(_ url: WebURI, headers: HTTPHeaders, beforeSend: @escaping BeforeSendAction, afterSend: @escaping AfterSendAction, progress: @escaping ProgressAction) async throws -> HTTPResponse
    ...
    @Sendable func asyncPost(_ url: WebURI, headers: HTTPHeaders, beforeSend: @escaping BeforeSendAction, afterSend: @escaping AsyncAfterSendAction, progress: @escaping ProgressAction) -> EventLoopFuture<HTTPResponse>
    @Sendable func asyncPatch(_ url: WebURI, headers: HTTPHeaders, beforeSend: @escaping BeforeSendAction, afterSend: @escaping AsyncAfterSendAction, progress: @escaping ProgressAction) -> EventLoopFuture<HTTPResponse>
